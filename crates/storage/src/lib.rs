...
//
// All durable I/O — crawl log, doc store, mmap read access, backups, and
// URL→DocumentId registry.
...
pub use self::url_registry::{UrlRegistry, UrlStatus};
...
pub enum Error {
    ...
    Compress { #[source] source: std::io::Error },
