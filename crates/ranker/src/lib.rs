...
impl Ranker {
    ...
    pub fn rank(
        ...
        // Final sort — guarantees correct order regardless of which phases ran.
        // Without this, rerank could change top-K relative order but the result
        // vec would still be in stale GBDT order.
